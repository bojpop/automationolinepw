export class EditRoom {
    ...
    async editRoomUpdate(roomname,type,accessible,price,image,description,wifi,refreshments,tv,safe,radio,views){
        ...
        await this.page.waitForLoadState(LoadState.NETWORKIDLE)
        // await this.roomName.waitFor()
        // await this.roomName.clear()
        ...
        await this.roomPrice.clear()
        await this.roomPrice.type(price)
